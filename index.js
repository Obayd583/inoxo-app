...
// إطلاق البثوث مع نظام الحماية الذكي
...
async function handleStreamUrl(ctx) {
    ...
    // تنظيف الرابط إذا كان مخلطاً بماركداون تليغرام
    ...
    bot.on('text', async (ctxNext) => {
        ...
        // قالب ذكي لتنظيف الفيس بوك من الأقواس والروابط المتكررة أوتوماتيكياً
...
// نظام الـ Anti-Crash لمنع البوت من الإغلاق نهائياً بسبب أي خطأ
